...
../configure --prefix=$HOME/local --mandir='${prefix}/share/man' --infodir='${prefix}/share/info' --sysconfdir=/etc \
    ...
    CPPFLAGS='-D_FORTIFY_SOURCE=2 -DPRE_RELEASE=0' \
     ...
     FCFLAGS='-g -O2 -fPIE -fstack-protector-strong' \
     FFLAGS='-g -O2 -fPIE -fstack-protector-strong' \
     GCJFLAGS='-g -O2 -fPIE -fstack-protector-strong' \
     LDFLAGS=-'Wl,-Bsymbolic-functions -fPIE -pie -Wl,-z,relro -Wl,-Bsymbolic' \
     OBJCFLAGS='-g -O2 -fPIE -fstack-protector-strong -Wformat -Werror=format-security' \
     OBJCXXFLAGS='-g -O2 -fPIE -fstack-protector-strong -Wformat -Werror=format-security' LIBS=