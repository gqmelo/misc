...
../../configure --prefix=$HOME/local --mandir=\${prefix}/share/man \
     ...
     CFLAGS="-g -O0 -fstack-protector-strong --param=ssp-buffer-size=4 -Wformat -Werror=format-security -Wall" \
     CPPFLAGS="-D_FORTIFY_SOURCE=2" \
     CXXFLAGS="-g -O0 -fstack-protector-strong --param=ssp-buffer-size=4 -Wformat -Werror=format-security -Wall" \
     FFLAGS="-g -O0 -fstack-protector-strong --param=ssp-buffer-size=4" \
     GCJFLAGS="-g -O0 -fstack-protector-strong --param=ssp-buffer-size=4" \
