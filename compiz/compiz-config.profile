...
[core]
s0_active_plugins = core;composite;opengl;grid;commands;vpswitch;compiztoolbox;snap;imgpng;resize;workarounds;mousepoll;neg;resizeinfo;annotate;showmouse;obs;put;thumbnail;unitymtgrabhandles;place;session;move;extrawm;wall;regex;copytex;expo;scale;ezoom;unityshell;
...
[neg]
s0_screen_toggle_key = <Super>comma
...
[annotate]
s0_initiate_free_draw_button = <Shift><Control><Super>Button1
s0_initiate_line_button = <Control><Super>Button1
s0_initiate_rectangle_button = <Control><Super>Button3
s0_initiate_ellipse_button = <Shift><Control><Super>Button3
s0_erase_button = <Shift><Control><Super>Button2
s0_clear_button = <Control><Super>Button2
s0_draw_shapes_from_center = false
s0_fill_color = #ff000000
...
s0_put_next_output_key = <Shift><Control><Super>Right

[ezoom]
s0_zoom_in_button = <Super>Button4
s0_zoom_in_key = <Control><Super>equal
...
[extrawm]
s0_toggle_always_on_top_key = <Super>Up
s0_activate_demands_attention_key = <Super>Right
